...
const Home =  ({ totalItems, itemsPerPage, currentPage, onPageChange }) => {
  ...
  const [selectedCategory, setSelectedCategory] = useState(null); const [activePage, setActivePage] = useState(currentPage || 1);
      ...
      <div className={styles.leftBox}>
        <div className="container">
          ...
          <div className={styles.horizontalContainer}>
            ...
            <button className={styles.shinybtn} onClick={openModal}>条件を選択する</button>
          </div>
          {isModalOpen && (
...
<div className={styles.horizontalContainer1}>
    ...
    <span>（全251636件中）</span>
    <ul>
        <li><a href="#page1" className={styles.active}>1</a></li>
